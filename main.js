...
function getWeather(city) {
  ...
  .catch(error => {
    console.log("Fetch error (current):", error.message);
    showAlert("City not found. Please enter a valid city.");
    clearWeatherDisplay(); // new function below
  });
...
function getWeatherForecast(city){
 ...
 .catch(error => {
  console.log("Fetch error (forecast):", error.message);
  showAlert("Could not load forecast. Please enter a valid city.");
  clearWeatherDisplay(); // same function
});
}
